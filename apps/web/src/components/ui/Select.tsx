      ...
      <div className="w-full space-y-1">
        ...
        <div className="relative flex items-center">
          ...
          <select
            id={id}
            ref={ref}
            className={`w-full appearance-none rounded-sm border bg-white py-2.5 text-xs font-semibold text-[#0D1F3D] transition-all cursor-pointer placeholder:text-slate-400 focus:border-purple-600 focus:outline-none ${

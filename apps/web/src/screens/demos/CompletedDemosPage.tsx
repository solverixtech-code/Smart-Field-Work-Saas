    ...
    <div className="space-y-4 font-sans pb-16 bg-slate-50/50 min-h-screen p-1 sm:p-2 text-left">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <div className="rounded-sm border border-slate-200/80 bg-white p-3.5 shadow-xs flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs font-semibold text-emerald-600 block">↑ 14.6% vs previous range</span>
          </div>
        </div>
        ...
        <div className="rounded-sm border border-slate-200/80 bg-white p-3.5 shadow-xs flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs font-medium text-slate-500 block">66.7% of completed</span>
          </div>
        </div>
        ...
        <div className="rounded-sm border border-slate-200/80 bg-white p-3.5 shadow-xs flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs font-medium text-slate-500 block">35.9% converted</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-2">
        ...
        <div className="rounded-sm border border-slate-200/80 bg-white p-4 shadow-xs space-y-2 text-xs font-semibold">
          <span className="text-xs font-semibold text-slate-500 block">Total Value Generated</span>
          <span className="text-2xl font-extrabold text-[#0D1F3D] block">₹18,45,000</span>
          <span className="text-xs font-medium text-slate-500 block">From 28 converted demos</span>
        </div>
        ...
        <div className="rounded-sm border border-slate-200/80 bg-white p-4 shadow-xs space-y-3 text-xs font-semibold">
          ...
          <div className="relative py-2 flex flex-col items-center justify-center">
            <div className="h-20 w-20 rounded-full border-4 border-emerald-500 border-t-teal-600 flex flex-col items-center justify-center shadow-xs">
              <span className="text-base font-extrabold text-[#0D1F3D]">78</span>
        ...
        <div className="rounded-sm border border-slate-200/80 bg-white p-4 shadow-xs space-y-3 text-xs font-semibold">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex items-center justify-between">
              <span className="font-extrabold text-[#0D1F3D]">Arjun Mehta</span>
              <span className="font-mono font-bold text-emerald-600">17 Converted</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="font-extrabold text-[#0D1F3D]">Neha Sharma</span>
              <span className="font-mono font-bold text-emerald-600">13 Converted</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="font-extrabold text-[#0D1F3D]">Pooja Yadav</span>
              <span className="font-mono font-bold text-emerald-600">10 Converted</span>
            </div>
          </div>
        </div>
      </div>

      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <div className="space-y-4 lg:col-span-4">
          ...
          <div className="rounded-sm border border-slate-200/80 bg-white p-4 shadow-xs space-y-2 text-xs font-semibold">
            ...
            <span className="text-[11px] text-slate-500 font-medium block">From 28 converted demos</span>
          </div>
          ...
          <div className="rounded-sm border border-slate-200/80 bg-white p-4 shadow-xs space-y-3 text-xs font-semibold">
            ...
            <div className="relative py-2 flex flex-col items-center justify-center">
              <div className="h-24 w-24 rounded-full border-8 border-emerald-500 border-t-teal-600 flex flex-col items-center justify-center shadow-inner">
                <span className="text-lg font-extrabold text-[#0D1F3D]">78</span>

    ...
    <div className="space-y-4 font-sans pb-16 bg-slate-50/50 min-h-screen p-1 sm:p-2">
      ...
      <form onSubmit={(e) => handleSubmit(e, false)} className="grid grid-cols-1 gap-4 lg:grid-cols-12">
        ...
        <div className="space-y-4 lg:col-span-8">
          ...
          <div className="rounded-md border border-slate-200/80 bg-white p-5 shadow-xs space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-semibold">
              ...
              <label
                ...
                className={`flex items-center gap-3 rounded-md border p-3.5 cursor-pointer transition-all ${
                  leadType === 'business'
          ...
          <div className="rounded-md border border-slate-200/80 bg-white p-5 shadow-xs space-y-4 text-xs font-semibold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-1 sm:col-span-1">
                ...
                <div className="flex rounded-md border border-slate-200 bg-white overflow-hidden focus-within:border-purple-600">

      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-xs font-medium text-slate-500">
            Recorded demo sessions, client feedback ratings, attendee counts,
            and key technical questions asked.
          </p>
        </div>
        ...
        <Button
          variant="accent"
          size="sm"
          onClick={() => toast.info("Schedule Product Demo modal opened")}

...
import { Shield, Lock, CheckCircle2, FileText, ArrowLeft, Mail, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 text-left selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <div className="bg-[#0D1F3D] text-white py-12 px-4 sm:px-8 text-center space-y-3">
        <div className="inline-flex items-center gap-2 bg-indigo-500/20 border border-indigo-400/30 text-indigo-200 text-xs font-bold px-3 py-1 rounded-full">
          <Shield className="h-3.5 w-3.5 text-indigo-400" /> Meta Compliant & Encrypted
        </div>
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight">Privacy Policy</h1>
        <p className="text-xs sm:text-sm text-slate-300 max-w-xl mx-auto font-medium">
          Learn how Visiblo SFW CRM collects, protects, and manages data from your account, Meta Lead Ads, and WhatsApp Business API integrations.
        </p>
      ...
      <main className="max-w-4xl mx-auto py-10 px-4 sm:px-6 space-y-8">
        <div className="bg-white rounded-xl border border-slate-200/80 p-6 sm:p-10 shadow-xs space-y-8 text-xs sm:text-sm leading-relaxed text-slate-700">
          ...
          <section className="space-y-3">
            ...
            <p>
              This Privacy Policy explains how <strong>Visiblo SFW CRM</strong> ("we", "us", or "our"), operated by Solverix Technologies, collects, uses, stores, and protects information when you use our SaaS application, website, and third-party platform integrations including <strong>Meta Lead Ads (Facebook & Instagram)</strong> and <strong>WhatsApp Business Cloud API</strong>.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>Your data is processed strictly for legitimate business operations within the Visiblo CRM platform:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-200/80 font-medium">
          ...
          <section className="space-y-3">
            ...
            <p className="bg-indigo-50/80 p-3 rounded-lg border border-indigo-200 text-indigo-900 font-medium">

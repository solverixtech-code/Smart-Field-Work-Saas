...
export const masterCategories: MasterCategoryConfig[] = [
  ...
  {
    id: 'shift_type',
    name: 'Shift & Roster Types',
    description: 'Work time schedules and roster templates for field staff (Morning Field Shift, Flexible Hours, Evening Audit).',
    group: 'HR & Personnel',
    totalLabel: 'Total Shift Types',
    addTitle: 'Add Shift Type',
    editTitle: 'Edit Shift Type',
    addLabel: 'Add Shift Type',
    searchPlaceholder: 'Search shift types...',
    defaultCodePrefix: 'SHIFT',
  },
  {
    id: 'skill_set',
    name: 'Employee Skill Sets',
    description: 'Competencies and technical skill sets for smart lead/task assignment (B2B Sales, POS Setup, Payment Recovery).',
    group: 'HR & Personnel',
    totalLabel: 'Total Skill Sets',
    addTitle: 'Add Skill Set',
    editTitle: 'Edit Skill Set',
    addLabel: 'Add Skill Set',
    searchPlaceholder: 'Search skill sets...',
    defaultCodePrefix: 'SKILL',
  },
  {
    id: 'document_type',
    name: 'KYC & Document Categories',
    description: 'Mandatory executive onboarding and compliance verification documents (Aadhaar, PAN, Driving License).',
    group: 'HR & Personnel',
    totalLabel: 'Total Document Types',
    addTitle: 'Add Document Category',
    editTitle: 'Edit Document Category',
    addLabel: 'Add Document Category',
    searchPlaceholder: 'Search document categories...',
    defaultCodePrefix: 'DOC',
  },
  {
    id: 'product_category',
    name: 'Product & SKU Heads',
    description: 'Solution offerings and hardware catalog heads sold by field executives (Visiblo POS, Field SaaS, AI Suite).',
    group: 'Sales & Pipeline',
    totalLabel: 'Total Product Categories',
    addTitle: 'Add Product Category',
    editTitle: 'Edit Product Category',
    addLabel: 'Add Product Head',
    searchPlaceholder: 'Search product categories...',
    defaultCodePrefix: 'PROD',
  },
  {
    id: 'deal_priority',
    name: 'Deal Priority Levels',
    description: 'Urgency classifications for sales opportunities (Urgent P0, High P1, Medium P2, Low P3).',
    group: 'Sales & Pipeline',
    totalLabel: 'Total Priority Levels',
    addTitle: 'Add Priority Level',
    editTitle: 'Edit Priority Level',
    addLabel: 'Add Priority Level',
    searchPlaceholder: 'Search priority levels...',
    defaultCodePrefix: 'PRIO',
  },
  {
    id: 'competitor_brand',
    name: 'Competitor Brands',
    description: 'Market competitors logged by executives during field prospecting (Petpooja, DotPe, Posist, Vyapar).',
    group: 'Sales & Pipeline',
    totalLabel: 'Total Competitors',
    addTitle: 'Add Competitor Brand',
    editTitle: 'Edit Competitor Brand',
    addLabel: 'Add Competitor',
    searchPlaceholder: 'Search competitor brands...',
    defaultCodePrefix: 'COMP',
  },
  {
    id: 'demo_failure_reason',
    name: 'Demo Failure Reasons',
    description: 'Standardized logs recorded when a product demo is cancelled or unsuccessful.',
    group: 'Demos & Follow-ups',
    totalLabel: 'Total Failure Reasons',
    addTitle: 'Add Demo Failure Reason',
    editTitle: 'Edit Demo Failure Reason',
    addLabel: 'Add Failure Reason',
    searchPlaceholder: 'Search demo failure reasons...',
    defaultCodePrefix: 'DEMFAIL',
  },
  {
    id: 'visit_objective',
    name: 'Field Check-in Objectives',
    description: 'Primary purpose of executive store visits (Sales Pitch, Contract Signing, Product Demo, Payment Collection).',
    group: 'Operations & Field',
    totalLabel: 'Total Check-in Objectives',
    addTitle: 'Add Check-in Objective',
    editTitle: 'Edit Check-in Objective',
    addLabel: 'Add Objective',
    searchPlaceholder: 'Search check-in objectives...',
    defaultCodePrefix: 'OBJ',
  },
  {
    id: 'visit_checklist',
    name: 'Field Visit Compliance Checklists',
    description: 'Mandatory verification steps before executive check-out (Store Photo, Geo-Stamp, Merchant Signature).',
    group: 'Operations & Field',
    totalLabel: 'Total Checklist Items',
    addTitle: 'Add Checklist Item',
    editTitle: 'Edit Checklist Item',
    addLabel: 'Add Checklist Item',
    searchPlaceholder: 'Search checklist items...',
    defaultCodePrefix: 'CHK',
  },
  {
    id: 'target_metric_type',
    name: 'Target Metric Types',
    description: 'Quota measurement units for target setting (Sales Revenue ₹, Demos Conducted, Field Visits, Collections ₹).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Target Metrics',
    addTitle: 'Add Target Metric Type',
    editTitle: 'Edit Target Metric Type',
    addLabel: 'Add Metric Type',
    searchPlaceholder: 'Search target metrics...',
    defaultCodePrefix: 'METRIC',
  },
  {
    id: 'incentive_tier',
    name: 'Commission Tier Slabs',
    description: 'Accelerated incentive payout tiers based on quota achievement (Standard 5%, Accelerated 8%, Super Tier 12%).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Commission Tiers',
    addTitle: 'Add Commission Tier',
    editTitle: 'Edit Commission Tier',
    addLabel: 'Add Tier Slab',
    searchPlaceholder: 'Search commission tiers...',
    defaultCodePrefix: 'TIER',
  },
  {
    id: 'merchant_status',
    name: 'Merchant Lifecycle Statuses',
    description: 'Account status of registered merchant stores (Unverified Lead, Verified Prospect, Active Customer, Churned).',
    group: 'Business & Merchants',
    totalLabel: 'Total Lifecycle Statuses',
    addTitle: 'Add Merchant Status',
    editTitle: 'Edit Merchant Status',
    addLabel: 'Add Status',
    searchPlaceholder: 'Search merchant statuses...',
    defaultCodePrefix: 'BIZSTAT',
  },
  {
    id: 'payout_account',
    name: 'Disbursement Bank Accounts',
    description: 'Corporate bank accounts & payout gateways used by Finance for incentive disbursal (HDFC Corporate, RazorpayX).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Disbursement Accounts',
    addTitle: 'Add Payout Account',
    editTitle: 'Edit Payout Account',
    addLabel: 'Add Account Head',
    searchPlaceholder: 'Search payout accounts...',
    defaultCodePrefix: 'ACCT',
  },
  {
    id: 'payout_frequency',
    name: 'Incentive Payout Frequencies',
    description: 'Disbursal cycle schedules (Monthly Payout, Quarterly Bonus, Annual Milestone).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Payout Frequencies',
    addTitle: 'Add Payout Frequency',
    editTitle: 'Edit Payout Frequency',
    addLabel: 'Add Frequency',
    searchPlaceholder: 'Search payout frequencies...',
    defaultCodePrefix: 'FREQ',
  },
  {
    id: 'target_period',
    name: 'Target Periods & Quota Frequencies',
    description: 'Target evaluation periods & duration heads (Monthly Quota, Quarterly Target, Financial Year 2025-26).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Target Periods',
    addTitle: 'Add Target Period',
    editTitle: 'Edit Target Period',
    addLabel: 'Add Target Period',
    searchPlaceholder: 'Search target periods...',
    defaultCodePrefix: 'PERIOD',
  },
  {
    id: 'target_type',
    name: 'Target Scope & Assignment Types',
    description: 'Target organizational scopes (Team Target, Individual Executive Target, Territory Zone Target).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Target Scopes',
    addTitle: 'Add Target Scope',
    editTitle: 'Edit Target Scope',
    addLabel: 'Add Scope Type',
    searchPlaceholder: 'Search target scope types...',
    defaultCodePrefix: 'SCOPE',
  },
  {
    id: 'target_status',
    name: 'Target Achievement Statuses',
    description: 'Performance tracking status indicators (On Track, At Risk, Behind Target, Target Exceeded).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Target Statuses',
    addTitle: 'Add Target Status',
    editTitle: 'Edit Target Status',
    addLabel: 'Add Status Indicator',
    searchPlaceholder: 'Search target achievement statuses...',
    defaultCodePrefix: 'TGSTAT',
  },
  {
    id: 'incentive_status',
    name: 'Incentive Disbursal Statuses',
    description: 'Commission calculation and payout workflow states (Draft / Calculated, Manager Approved, Paid).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Disbursal Statuses',
    addTitle: 'Add Disbursal Status',
    editTitle: 'Edit Disbursal Status',
    addLabel: 'Add Disbursal Status',
    searchPlaceholder: 'Search disbursal statuses...',
    defaultCodePrefix: 'INCSTAT',
  },
  {
    id: 'incentive_rule_type',
    name: 'Incentive Calculation Methods',
    description: 'Mathematical rules for commission calculation (Revenue %, Slab Fixed Amount, Accelerated Growth %).',
    group: 'Payroll & Subscriptions',
    totalLabel: 'Total Calculation Rules',
    addTitle: 'Add Calculation Method',
    editTitle: 'Edit Calculation Method',
    addLabel: 'Add Calculation Method',
    searchPlaceholder: 'Search calculation methods...',
    defaultCodePrefix: 'CALCRULE',
  },
];
...
export const initialMasterRecords: Record<string, MasterRecordItem[]> = {
  ...
  // NEW MASTERS RECORDS
  shift_type: [
    { id: 'shift-1', category: 'shift_type', name: 'Morning Field Shift (9 AM - 6 PM)', code: 'MORNING_FIELD', description: 'Standard B2B merchant field visit timing.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'shift-2', category: 'shift_type', name: 'Flexible Field Hours', code: 'FLEX_FIELD', description: 'Self-scheduled field visits with minimum 8h active tracking.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
    { id: 'shift-3', category: 'shift_type', name: 'Evening Retail Audit (2 PM - 10 PM)', code: 'EVENING_AUDIT', description: 'Late shift for restaurant & nightlife merchant onboarding.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#D97706' },
  ],
  skill_set: [
    { id: 'skill-1', category: 'skill_set', name: 'B2B Enterprise SaaS Sales', code: 'SAAS_SALES', description: 'High-value multi-store deal negotiation.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#059669' },
    { id: 'skill-2', category: 'skill_set', name: 'Retail POS Technical Setup', code: 'POS_SETUP', description: 'Onsite hardware and software configuration.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'skill-3', category: 'skill_set', name: 'Payment Recovery & Audit', code: 'PAY_RECOVERY', description: 'Overdue payment collection specialist.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#DC2626' },
  ],
  document_type: [
    { id: 'doc-1', category: 'document_type', name: 'Aadhaar Identity Verification', code: 'AADHAAR', description: 'Mandatory Government Identity Card.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'doc-2', category: 'document_type', name: 'PAN Card Copy', code: 'PAN_CARD', description: 'Tax ID for salary processing & TDS deduction.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#059669' },
    { id: 'doc-3', category: 'document_type', name: 'Driving License (Commercial/DL)', code: 'DRIVING_LIC', description: 'Mandatory for two-wheeler field executives.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#D97706' },
  ],
  product_category: [
    { id: 'prod-1', category: 'product_category', name: 'Visiblo Smart POS Hardware', code: 'POS_TERMINAL', description: 'Android touchscreen smart POS billing terminal.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
    { id: 'prod-2', category: 'product_category', name: 'Field Executive Tracking SaaS', code: 'FIELD_SAAS', description: 'Monthly subscription for GPS & visit tracking app.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'prod-3', category: 'product_category', name: 'WhatsApp Marketing & CRM Suite', code: 'WA_CRM', description: 'Automated WhatsApp review & promotional campaigns.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#059669' },
  ],
  deal_priority: [
    { id: 'prio-1', category: 'deal_priority', name: 'Urgent (P0 - Immediate Action)', code: 'P0_URGENT', description: 'High value hot deal closing within 24 hours.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#DC2626' },
    { id: 'prio-2', category: 'deal_priority', name: 'High (P1 - Priority Pitch)', code: 'P1_HIGH', description: 'Standard high-intent prospect requiring demo.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#D97706' },
    { id: 'prio-3', category: 'deal_priority', name: 'Normal (P2 - Standard Cadence)', code: 'P2_NORMAL', description: 'Regular lead pipeline progression.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
  ],
  competitor_brand: [
    { id: 'comp-1', category: 'competitor_brand', name: 'Petpooja POS', code: 'PETPOOJA', description: 'Restaurant billing and inventory software.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#EF4444' },
    { id: 'comp-2', category: 'competitor_brand', name: 'DotPe Store Manager', code: 'DOTPE', description: 'Digital catalog and order management app.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#3B82F6' },
    { id: 'comp-3', category: 'competitor_brand', name: 'Vyapar Accounting', code: 'VYAPAR', description: 'Small retail billing and GST invoicing app.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#10B981' },
  ],
  demo_failure_reason: [
    { id: 'demfail-1', category: 'demo_failure_reason', name: 'Store Internet / Wi-Fi Offline', code: 'NET_OFFLINE', description: 'Demo could not proceed due to poor connectivity.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#DC2626' },
    { id: 'demfail-2', category: 'demo_failure_reason', name: 'Key Decision Maker Absent', code: 'OWNER_ABSENT', description: 'Only store staff present, owner unavailable for signoff.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#D97706' },
    { id: 'demfail-3', category: 'demo_failure_reason', name: 'Hardware Incompatible', code: 'HW_INCOMPAT', description: 'Merchant legacy printer or scanner incompatible.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#6B7280' },
  ],
  visit_objective: [
    { id: 'obj-1', category: 'visit_objective', name: 'First Prospecting & Pitch', code: 'FIRST_PITCH', description: 'Initial store introduction and need discovery.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'obj-2', category: 'visit_objective', name: 'Onsite Product Demonstration', code: 'ONSITE_DEMO', description: 'Live feature demo on merchant tablet/desktop.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
    { id: 'obj-3', category: 'visit_objective', name: 'Contract Signing & Onboarding', code: 'ONBOARDING', description: 'KYC collection, agreement signature & setup.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#059669' },
  ],
  visit_checklist: [
    { id: 'chk-1', category: 'visit_checklist', name: 'Store Front Photo Captured', code: 'STORE_PHOTO', description: 'Upload geotagged store facade photograph.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#059669' },
    { id: 'chk-2', category: 'visit_checklist', name: 'GPS Location Radius Stamp', code: 'GPS_STAMP', description: 'Verify executive check-in within 50m of merchant.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'chk-3', category: 'visit_checklist', name: 'Merchant Digital Sign-off', code: 'MERCHANT_SIGN', description: 'Obtain digital signature on executive mobile app.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
  ],
  target_metric_type: [
    { id: 'metric-1', category: 'target_metric_type', name: 'Gross Revenue Sales (₹)', code: 'REVENUE_INR', description: 'Total closed won subscription & hardware revenue.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#059669' },
    { id: 'metric-2', category: 'target_metric_type', name: 'Completed Field Visits', code: 'VISITS_COUNT', description: 'Total verified store check-in visits completed.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'metric-3', category: 'target_metric_type', name: 'Demos Delivered', code: 'DEMOS_COUNT', description: 'Successful product walkthroughs conducted.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
  ],
  incentive_tier: [
    { id: 'tier-1', category: 'incentive_tier', name: 'Base Tier (100% Target = 5%)', code: 'BASE_5PCT', description: 'Standard commission rate for meeting monthly target.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'tier-2', category: 'incentive_tier', name: 'Accelerated Tier (>110% = 8%)', code: 'ACCEL_8PCT', description: 'Booster rate for exceeding target quota.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#059669' },
    { id: 'tier-3', category: 'incentive_tier', name: 'Super Tier (>125% = 12%)', code: 'SUPER_12PCT', description: 'Top performer rate for 125%+ quota achievement.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#D97706' },
  ],
  merchant_status: [
    { id: 'bizstat-1', category: 'merchant_status', name: 'Unverified Lead', code: 'UNVERIFIED', description: 'Newly added store lead pending verification.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#6B7280' },
    { id: 'bizstat-2', category: 'merchant_status', name: 'Verified Active Prospect', code: 'ACTIVE_PROSPECT', description: 'Store details verified, active in sales pipeline.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#3B82F6' },
    { id: 'bizstat-3', category: 'merchant_status', name: 'Live Onboarded Customer', code: 'LIVE_CUSTOMER', description: 'Active paying subscriber store.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#10B981' },
  ],
  payout_account: [
    { id: 'acct-1', category: 'payout_account', name: 'HDFC Corporate Current Account', code: 'HDFC_CORP', description: 'Primary bank account for executive salary & commission.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'acct-2', category: 'payout_account', name: 'RazorpayX Instant Payout API', code: 'RAZORPAYX', description: 'Automated instant UPI & NEFT incentive gateway.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
  ],
  payout_frequency: [
    { id: 'freq-1', category: 'payout_frequency', name: 'Monthly Disbursal Cycle', code: 'MONTHLY', description: 'Paid alongside monthly payroll on 1st of every month.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#059669' },
    { id: 'freq-2', category: 'payout_frequency', name: 'Quarterly Milestone Bonus', code: 'QUARTERLY', description: 'Paid at the end of Q1, Q2, Q3, Q4 financial quarters.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#D97706' },
  ],
  target_period: [
    { id: 'period-1', category: 'target_period', name: 'May 2025 (Current Month)', code: 'MAY_2025', description: 'Monthly performance quota period for May 2025.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'period-2', category: 'target_period', name: 'June 2025 (Upcoming)', code: 'JUNE_2025', description: 'Monthly performance quota period for June 2025.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
    { id: 'period-3', category: 'target_period', name: 'Q2 2025 (Apr - Jun)', code: 'Q2_2025', description: 'Quarterly performance drive period.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#059669' },
    { id: 'period-4', category: 'target_period', name: 'Annual FY 2025-26', code: 'FY_2025_26', description: 'Annual strategic target milestone period.', sortOrder: 4, isActive: true, isSystemDefault: true, displayColor: '#D97706' },
  ],
  target_type: [
    { id: 'scope-1', category: 'target_type', name: 'Team Target Cluster', code: 'TEAM_SCOPE', description: 'Target assigned to entire sales team / branch unit.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
    { id: 'scope-2', category: 'target_type', name: 'Individual Executive Quota', code: 'INDIVIDUAL_SCOPE', description: 'Target assigned to single field executive.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'scope-3', category: 'target_type', name: 'Territory Zone Target', code: 'TERRITORY_SCOPE', description: 'Geographic zone revenue and visit target.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#059669' },
  ],
  target_status: [
    { id: 'tgstat-1', category: 'target_status', name: 'On Track (≥ 80% Achieved)', code: 'ON_TRACK', description: 'Target achievement meeting scheduled milestone timeline.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#10B981' },
    { id: 'tgstat-2', category: 'target_status', name: 'At Risk (60% - 79% Achieved)', code: 'AT_RISK', description: 'Target achievement slightly lagging timeline.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#F59E0B' },
    { id: 'tgstat-3', category: 'target_status', name: 'Behind Target (< 60% Achieved)', code: 'BEHIND', description: 'Target requiring immediate intervention.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#EF4444' },
    { id: 'tgstat-4', category: 'target_status', name: 'Target Exceeded (≥ 100%)', code: 'EXCEEDED', description: 'Target milestone fully met or exceeded.', sortOrder: 4, isActive: true, isSystemDefault: true, displayColor: '#8B5CF6' },
  ],
  incentive_status: [
    { id: 'incstat-1', category: 'incentive_status', name: 'Draft / Calculated', code: 'DRAFT_CALC', description: 'Automated commission calculated, pending review.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#6B7280' },
    { id: 'incstat-2', category: 'incentive_status', name: 'Manager Approved', code: 'MGR_APPROVED', description: 'Approved by Regional Sales Manager.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#3B82F6' },
    { id: 'incstat-3', category: 'incentive_status', name: 'Finance Verified', code: 'FINANCE_VERIFIED', description: 'Verified by Finance & Payroll Ops.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#10B981' },
    { id: 'incstat-4', category: 'incentive_status', name: 'Paid / Disbursed', code: 'DISBURSED', description: 'Commission credited to executive bank account.', sortOrder: 4, isActive: true, isSystemDefault: true, displayColor: '#059669' },
  ],
  incentive_rule_type: [
    { id: 'calcrule-1', category: 'incentive_rule_type', name: 'Percentage of Revenue (%)', code: 'PCT_REVENUE', description: 'Fixed percentage commission on total closed won revenue.', sortOrder: 1, isActive: true, isSystemDefault: true, displayColor: '#2563EB' },
    { id: 'calcrule-2', category: 'incentive_rule_type', name: 'Slab Fixed Bonus Amount (₹)', code: 'SLAB_FIXED', description: 'Fixed cash bonus awarded upon crossing slab milestone.', sortOrder: 2, isActive: true, isSystemDefault: true, displayColor: '#7C3AED' },
    { id: 'calcrule-3', category: 'incentive_rule_type', name: 'Accelerated Multiplier (1.5x)', code: 'ACCEL_MULTIPLIER', description: 'Higher commission rate applied on deals above 100% quota.', sortOrder: 3, isActive: true, isSystemDefault: true, displayColor: '#059669' },
  ],
};

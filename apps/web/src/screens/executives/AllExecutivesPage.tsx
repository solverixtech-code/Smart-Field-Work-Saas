...
export default function AllExecutivesPage() {
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      {/* Main Grid: Data Table + Right Overview Sidebar */}
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="space-y-4 lg:col-span-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200/80 bg-white p-3.5 shadow-xs">
            ...
            <select
              ...
              className="rounded-xl border border-slate-200 bg-slate-50/60 px-3 py-2 text-xs font-bold text-[#0D1F3D] focus:border-[#E20613] focus:outline-none"
            >
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-sm">
              ...
              <table className="w-full text-left text-xs font-semibold">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/60 text-[11px] font-extrabold text-slate-500 uppercase tracking-wider">
                    ...
                    <th className="px-4 py-3.5">Team & Region</th>
                  ...
                  {filteredExecutives.map((exec) => {
                    ...
                    return (
                      <tr key={exec.id} className="hover:bg-slate-50/80 transition-colors">
                          ...
                          <div className="flex items-center gap-2.5">
                            ...
                            <div>
                              <NavLink
                                ...
                                className="font-extrabold text-[#0D1F3D] hover:text-[#E20613] hover:underline"
                              >
                                {exec.name}
                              </NavLink>
                            </div>
                        ...
                        <td className="px-4 py-3.5 font-bold text-slate-500">{exec.id}</td>
                        <td className="px-4 py-3.5">
                          <div>
                            <p className="font-bold text-[#0D1F3D]">{exec.team}</p>
                            <p className="text-[10px] text-slate-400 font-medium">{exec.region}</p>
                          </div>
                        </td>
                        <td className="px-4 py-3.5 font-semibold text-slate-600">{exec.mobile}</td>
                        <td className="px-4 py-3.5">
                          <span
                        ...
                        <td className="px-4 py-3.5">
                          <div>
                            <p className="font-extrabold text-[#0D1F3D]">{exec.visits}</p>
                            <p className="text-[10px] font-semibold text-[#E20613]">{exec.leads}</p>
                          </div>
                        </td>
                        <td className="px-4 py-3.5 text-slate-500 font-medium">{exec.joinDate}</td>
            ...
            <div className="flex items-center justify-between border-t border-slate-100 px-4 py-3 text-xs font-medium text-slate-500">
        ...
        {/* Right Column: Team Overview Donut, Top Performers, Quick Actions */}

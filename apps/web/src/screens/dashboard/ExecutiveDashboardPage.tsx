...
import RoutePlaybackPage from '../maps/RoutePlaybackPage';
...
export default function ExecutiveDashboardPage() {
  ...
  if (['field_executive', 'sales_executive', 'executive'].includes(roleCode.toLowerCase())) {
    return <RoutePlaybackPage />;
  }
  return (

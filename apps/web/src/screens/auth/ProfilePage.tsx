      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm lg:col-span-8">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 text-xs">
            ...
            <div className="space-y-1">
              <label className="font-bold text-slate-500 block">Employee ID</label>
              <input
                type="text"
                readOnly
            ...
            <div className="space-y-1">
              <label className="font-bold text-slate-500 block">Designation</label>
              <input
                type="text"
                readOnly={!isEditing}
            ...
            <div className="space-y-1">
              <label className="font-bold text-slate-500 block">Date of Birth</label>
              <input
                type="text"
                readOnly={!isEditing}
            ...
            <div className="space-y-1">
              <label className="font-bold text-slate-500 block">Address</label>
              <input
                type="text"
                readOnly={!isEditing}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm lg:col-span-6">
          ...
          <div className="space-y-3.5 text-xs font-semibold">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
              <span className="flex items-center gap-2.5 text-slate-600">
                <Mail className="h-4 w-4 text-slate-400" /> Email Verification
              </span>
              <span className="rounded-md bg-emerald-50 border border-emerald-200 px-2 py-0.5 text-[11px] font-extrabold text-emerald-600">
                Verified
              </span>
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
              <span className="flex items-center gap-2.5 text-slate-600">
                <Clock className="h-4 w-4 text-slate-400" /> Last Active Login
              </span>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm lg:col-span-6">
          ...
          <div className="space-y-3.5 text-xs font-semibold">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
              <span className="flex items-center gap-2.5 text-slate-600">
                <MapPin className="h-4 w-4 text-slate-400" /> Administrative Role
              </span>
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
              <span className="flex items-center gap-2.5 text-slate-600">
                <Key className="h-4 w-4 text-slate-400" /> System Permissions
              </span>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-[10px] text-slate-400">By System Security</p>
              </div>
            </div>
          </div>
        </div>

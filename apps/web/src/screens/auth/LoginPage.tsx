    ...
    <AuthLayout>
      <div className="w-full min-h-[580px] flex flex-col justify-between rounded-3xl border border-slate-200/80 bg-white p-8 sm:p-10 shadow-xl space-y-6">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="absolute bg-white px-3 text-xs font-semibold text-slate-400">Demo Accounts</span>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              type="button"
              onClick={() => {
                setEmail('vikram.singh@solverixtech.com');
                setPassword('Solverix@2025');
                toast.success('Field Executive credentials loaded!');
              }}
            ...
            <button
              type="button"
              onClick={() => {
                setEmail('priya.mehta@solverixtech.com');
                setPassword('Solverix@2025');

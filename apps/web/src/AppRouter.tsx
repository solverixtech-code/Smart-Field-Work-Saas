...
} from "./screens/notifications/NotificationsPages";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/data-deletion"
          element={<DataDeletionInstructionsPage />}
        />
        <Route
        ...
        <Route element={<ProtectedRoute />}>
          ...
          >
            ...
            >
              <Route
                path="/admin/dashboard/field"
                element={<FieldActivityDashboardPage />}
              />
            </Route>

            {/* Revenue Dashboard */}
            <Route
              element={<PermissionRoute permission="payroll.payslips.view" />}
            >
              <Route
            ...
            >
              <Route
                ...
                element={<ConversionDashboardPage />}
              />
            </Route>
            ...
            />
            <Route
              path="/admin/profile/sessions"
              element={<ActiveSessionsPage />}
            />

            {/* Field Executives & Sales Manager Management Routes */}
            <Route
              element={<PermissionRoute permission="crm.executives.view" />}
            >
              <Route path="/admin/executives" element={<AllExecutivesPage />} />
              <Route
                path="/admin/executives/new"
                element={<AddExecutivePage />}
              />
              <Route
            ...
            <Route
              element={<PermissionRoute permission="workforce.shifts.view" />}
            >
              <Route path="/admin/shifts" element={<ShiftManagementPage />} />
            </Route>
            <Route
              element={
                <PermissionRoute permission="attendance.monitoring.view" />
              }
            >
              <Route
            ...
            <Route element={<PermissionRoute permission="crm.teams.view" />}>
              ...
              />
              <Route
                path="/admin/teams/:teamId/leader"
                element={<AssignTeamLeaderPage />}
              />
              <Route
              ...
              />
              <Route
                path="/admin/teams/:teamId/performance"
                element={<TeamPerformancePage />}
              />
              <Route
                path="/admin/teams/:teamId/targets"
                element={<TeamTargetsPage />}
              />
            </Route>
            ...
            <Route element={<PermissionRoute permission="crm.targets.view" />}>
              ...
              <Route
                path="/admin/targets/executives"
                element={<ExecutiveTargetsScreen />}
              />
              <Route
                path="/admin/targets/teams"
                element={<TeamTargetsScreen />}
              />
              <Route
            ...
            <Route element={<PermissionRoute permission="crm.incentives.view" />}>
              ...
              <Route
                ...
                element={<IncentivesManagementPage />}
              />
              <Route
                path="/admin/incentives/approvals"
                element={<IncentivesManagementPage />}
              />
              <Route
                path="/admin/incentives/payouts"
                element={<IncentivesManagementPage />}
              />
              <Route
                path="/admin/incentives/:executiveId"
                element={<IncentivesManagementPage />}
              />
            </Route>
            ...
            <Route
              element={<PermissionRoute permission="crm.performance.view" />}
            >
              <Route
              ...
              />
              <Route
                path="/admin/performance/executives"
                element={<ExecutiveRankingPage />}
              />
              <Route
                path="/admin/performance/teams"
                element={<TeamRankingPage />}
              />
              <Route
                path="/admin/performance/territories"
                element={<TerritoryRankingPage />}
              />
              <Route
                path="/admin/performance/categories"
                element={<CategoryPerformancePage />}
              />
              <Route
                path="/admin/performance/funnel"
                element={<ConversionFunnelPage />}
              />
              <Route
                path="/admin/performance/productivity"
            ...
            <Route
              element={<PermissionRoute permission="crm.categories.view" />}
            >
              ...
              />
              <Route
                path="/admin/categories/:categoryId/performance"
                element={<CategoryPerformancePage />}
              />
            </Route>
            ...
            <Route element={<PermissionRoute permission="crm.leads.view" />}>
              <Route
                ...
                element={<AllLeadSourcesPage />}
              />
              <Route
                path="/admin/leads/sources/create"
                element={<AddLeadSourcePage />}
              />
              <Route
                path="/admin/leads/sources/:sourceId"
                element={<LeadSourceDetailsPage />}
              />
              <Route
                path="/admin/leads/integrations"
                element={<LeadIntegrationsDashboard />}
              />
              <Route
                path="/admin/leads/automation"
                element={<LeadAutomationCenter />}
              />
              <Route
                path="/admin/leads/integrations/meta/connect"
                element={<ConnectMetaWizardPage />}
              />
              <Route
                path="/admin/leads/integrations/google/connect"
                element={<ConnectGoogleAdsWizardPage />}
              />
              <Route
                path="/admin/leads/integrations/whatsapp/connect"
                element={<ConnectWhatsAppWizardPage />}
              />
              <Route
                path="/admin/leads/automation/settings"
                element={<AutomationSettingsPage />}
              />
              <Route
                path="/admin/leads/automation/activity"
                element={<LiveLeadActivityPage />}
              />
            </Route>

            {/* Customer & Subscription Linkage Routes (Screens 151 to 155) */}
            <Route
              element={<PermissionRoute permission="crm.customers.view" />}
            >
              <Route
                path="/admin/customers"
                element={<ConvertedCustomersPage />}
              />
              <Route
                path="/admin/customers/field-sales"
                element={<ConvertedCustomersPage />}
              />
              <Route
              ...
              />
              <Route
                path="/admin/customers/:customerId/subscription"
                element={<SubscriptionDetailsPage />}
              />
              <Route
                path="/admin/customers/:customerId/renewal"
                element={<RenewalStatusPage />}
              />
            </Route>

            {/* Notifications (Screens 163 to 167) */}
            <Route
              element={<PermissionRoute permission="crm.notifications.view" />}
            >
              <Route
              ...
              />
              <Route
                path="/admin/notifications/executives"
                element={<ExecutiveAlertsPage />}
              />
              <Route
            ...
            <Route element={<PermissionRoute permission="crm.reports.view" />}>
              ...
              />
              <Route
                path="/admin/reports/territories"
                element={<TerritoryReportPage />}
              />
              <Route
                path="/admin/reports/conversions"
                element={<LeadConversionReportPage />}
              />
              <Route
              ...
              />
              <Route
                path="/admin/reports/incentives"
                element={<IncentiveReportPage />}
              />
              <Route
                path="/admin/reports/categories"
                element={<CategoryRoiReportPage />}
              />
            </Route>
            ...
            <Route
              element={
                <PermissionRoute permission="payroll.salary_structure.manage" />
              }
            >
              <Route
            ...
            <Route element={<PermissionRoute permission="crm.leads.view" />}>
              <Route element={<CrmBoundary />}>
                ...
                <Route
                  path="/admin/leads/bulk-assign"
                  element={<BulkAssignLeadsPage />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<LeadExportPage />}
                />
                <Route
                  path="/admin/leads/unassigned"
                  element={<AllLeadsPage viewMode="unassigned" />}
                />
                <Route
                  path="/admin/leads/hot"
                  element={<AllLeadsPage viewMode="hot" />}
                />
                <Route
                  path="/admin/leads/follow-up"
                  element={<AllLeadsPage viewMode="follow-up" />}
                />
                <Route
                  path="/admin/leads/converted"
                  element={<AllLeadsPage viewMode="converted" />}
                />
                <Route
                  path="/admin/leads/lost"
                  element={<AllLeadsPage viewMode="lost" />}
                />
                <Route
                  path="/admin/leads/not-interested"
                  element={<AllLeadsPage viewMode="not-interested" />}
                />
                <Route
                  path="/admin/leads/duplicates"
                  element={<AllLeadsPage viewMode="duplicates" />}
                />
                <Route
                ...
                />
                <Route
                  path="/admin/leads/:leadId/edit"
                  element={<EditLeadPage />}
                />
                <Route
                  path="/admin/leads/:leadId/timeline"
                  element={<LeadDetailsPage />}
                />
                <Route
                  path="/admin/leads/:leadId/visits"
                  element={<LeadDetailsPage />}
                />
                <Route
                ...
                />
                <Route
                  path="/admin/leads/:leadId/demos"
                  element={<LeadDetailsPage />}
                />
                <Route
                  path="/admin/leads/:leadId/communications"
                  element={<LeadDetailsPage />}
                />
                <Route
                  path="/admin/leads/:leadId/payments"
                  element={<LeadDetailsPage />}
                />
                <Route
                  path="/admin/leads/:leadId/assignment"
                  element={<LeadDetailsPage />}
                />
              </Route>
            </Route>
            ...
            <Route element={<PermissionRoute permission="crm.leads.view" />}>
              <Route element={<CrmBoundary />}>
                ...
                />
                <Route
                  path="/admin/sales/prospects"
                  element={<SalesStageViewPage stageKeyOverride="prospects" />}
                />
                <Route
                  path="/admin/sales/contacted"
                  element={<SalesStageViewPage stageKeyOverride="contacted" />}
                />
                <Route
                  path="/admin/sales/demo"
                  element={<SalesStageViewPage stageKeyOverride="demo" />}
                />
                <Route
                  path="/admin/sales/interested"
                  element={<SalesStageViewPage stageKeyOverride="interested" />}
                />
                <Route
                  path="/admin/sales/negotiation"
                  element={
                    <SalesStageViewPage stageKeyOverride="negotiation" />
                  }
                />
                <Route
                  path="/admin/sales/payment-pending"
                  element={
                    <SalesStageViewPage stageKeyOverride="payment-pending" />
                  }
                />
                <Route
                  path="/admin/sales/won"
                  element={<SalesStageViewPage stageKeyOverride="won" />}
                />
                <Route
                  path="/admin/sales/lost"
                  element={<SalesStageViewPage stageKeyOverride="lost" />}
                />
              </Route>
            </Route>
            ...
            <Route
              element={<PermissionRoute permission="crm.businesses.view" />}
            >
              <Route element={<CrmBoundary />}>
                <Route
                ...
                />
                <Route
                  path="/admin/businesses/:businessId/edit"
                  element={<AddBusinessPage isEdit />}
                />
                <Route
                ...
                >
                  ...
                  <Route
                    path="sales-history"
                    element={<BusinessSalesHistoryPage />}
                  />
                  <Route path="visits" element={<BusinessVisitHistoryPage />} />
                  <Route
                    path="subscription"
                    element={<BusinessSubscriptionPage />}
                  />
                </Route>
              </Route>
            </Route>
            ...
            <Route
              element={<PermissionRoute permission="system.masters.view" />}
            >
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<PlatformShell />}>
            <Route
              element={
                <PlatformAccessGuard requiredPermission="platform.dashboard.view" />
              }
            >
              <Route
                path="/platform"
              ...
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.tenants.view" />
                }
              >
              ...
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.tenants.create" />
                }
              >
                <Route
                  path="/platform/tenants/create"
                  element={<CreateTenantWizardPage />}
                />
              </Route>
              <Route
              ...
              />
              <Route
                path="/platform/tenants/requests"
                element={<Navigate to="/platform/tenants" replace />}
              />
              <Route
                element={
              ...
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.tenants.members.manage" />
                }
              >
                <Route
              ...
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.plans.create" />
                }
              >
                <Route
                  path="/platform/plans/create"
                  element={<CreatePlanWizardPage />}
                />
              </Route>
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.plans.view" />
                }
              >
                ...
                />
                <Route
                  path="/platform/plans/:planId/pricing"
                  element={<PlanDetailsPage />}
                />
                <Route
                  path="/platform/plans/:planId/limits"
                  element={<PlanDetailsPage />}
                />
                <Route
                  path="/platform/plans/:planId/modules"
                  element={<PlanDetailsPage />}
                />
                <Route
                  path="/platform/plans/:planId/tenants"
                  element={<PlanDetailsPage />}
                />
                <Route
                  path="/platform/plans/:planId/versions"
                  element={<PlanDetailsPage />}
                />
              </Route>
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.modules.view" />
                }
              >
                <Route
                  path="/platform/modules"
                  element={<ModulesFeaturesPage />}
                />
                <Route
                  path="/platform/modules/features"
                  element={<FeatureRegistryPage />}
                />
                <Route
                  path="/platform/modules/dependencies"
                  element={<DependencyMapPage />}
                />
                <Route
                  path="/platform/modules/:moduleId"
                  element={<ModuleDetailPage />}
                />
                <Route
                  path="/platform/modules/:moduleId/features"
                  element={<ModuleDetailPage />}
                />
                <Route
                  path="/platform/modules/:moduleId/dependencies"
                  element={<ModuleDetailPage />}
                />
                <Route
                  path="/platform/modules/:moduleId/history"
                  element={<ModuleDetailPage />}
                />
              </Route>
              <Route
                path="/platform/modules/create"
                element={<Navigate to="/platform/modules" replace />}
              />
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.modules.update" />
                }
              >
                <Route
                  path="/platform/modules/:moduleId/edit"
                  element={<EditModulePage />}
                />
              </Route>
              <Route
                element={
                  <PlatformAccessGuard requiredPermission="platform.industries.view" />
                }
              >
                <Route
              ...
              <Route
                ...
                element={
                  <PlatformPlaceholderPage title="Subscription Management" />
                }
              />
              <Route
                path="/platform/invoices"
                element={<PlatformPlaceholderPage title="Invoices & Billing" />}
              />
              <Route
                path="/platform/transactions"
                element={
                  <PlatformPlaceholderPage title="Payment Transactions" />
                }
              />
              <Route
                path="/platform/reports"
                element={
                  <PlatformPlaceholderPage title="Platform Analytics & Reports" />
                }
              />
              <Route path="/platform/profile" element={<ProfilePage />} />
              <Route
                path="/platform/profile/security"
                element={<ChangePasswordPage />}
              />
              <Route
                path="/platform/profile/sessions"
                element={<ActiveSessionsPage />}
              />
            </Route>
          </Route>

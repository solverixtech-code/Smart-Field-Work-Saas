...
export default function PlatformShell() {
  ...
  const { role, setRole, canCreateTenant, hasPlatformPermission } =
      ...
      items: [
        {
          ...
          permission: "platform.dashboard.view" as const,
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          badge: "Wizard",
          permission: "platform.tenants.create" as const,
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: Sliders,
          to: "/platform/modules",
          permission: "platform.tenants.modules.manage" as const,
        },
        {
          label: "Industries",
          icon: Globe,
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          permission: "platform.billing.view" as const,
        },
        {
          label: "Transactions",
          icon: ArrowRightLeft,
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.badge && (
                        <span
                          className={`text-[10px] font-extrabold px-1.5 py-0.5 rounded-sm ${
                            isActive
                              ? "bg-white text-[#E20613]"

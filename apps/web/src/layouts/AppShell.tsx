...
const navCategories: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      { label: "Reports Dashboard", icon: FileText, to: "/admin/reports", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER, Role.TEAM_LEADER], badge: "11 Reports" },
      { label: "Daily Sales Report", icon: TrendingUp, to: "/admin/reports/daily-sales", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER, Role.TEAM_LEADER] },
      { label: "Executive Report", icon: Users, to: "/admin/reports/executives", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER, Role.TEAM_LEADER] },
      { label: "Visit Report", icon: MapPin, to: "/admin/reports/visits", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER, Role.TEAM_LEADER] },
      { label: "Territory Report", icon: Layers, to: "/admin/reports/territories", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER] },
      { label: "Lead Conversion Report", icon: Filter, to: "/admin/reports/conversions", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER, Role.TEAM_LEADER] },
      { label: "Revenue Report", icon: BarChart3, to: "/admin/reports/revenue", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER] },
      { label: "Payment Report", icon: CreditCard, to: "/admin/reports/payments", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER] },
      { label: "Attendance Report", icon: CalendarCheck, to: "/admin/reports/attendance", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER, Role.TEAM_LEADER] },
      { label: "Incentive Report", icon: Award, to: "/admin/reports/incentives", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER] },
      { label: "Category ROI Report", icon: PieChart, to: "/admin/reports/categories", allowed: [Role.SUPER_ADMIN, Role.ADMIN, Role.SALES_MANAGER] },
    ],
  },
  {
